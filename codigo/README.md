...
Esta carpeta contiene el pipeline analítico reproducible del paper SONAR antes de recoger datos reales.

## Contenido
- `data/simulated/`: datos simulados coherentes con el diseño principal.
...
- `docs/`: plan de análisis preregistrado, codebook y plan de figuras.

La configuración experimental principal se sincroniza con [project_parameters.json](/C:/Users/Usuario/Desktop/AAC/codex/2026%20SONAR/project_parameters.json), de modo que nombres como `seed_low` y `seed_high`, el tamaño de ventana y la longitud de serie no tengan que reescribirse a mano en cada script.
...
3. Mantén los nombres de columnas clave del export real para que el pipeline siga funcionando sin rehacer modelos ni figuras.
