...
const es = withServerErrors({
  ...
  bonusDraw: {
    ...
    prompt:
      ...
      inviteTicket: "1 extra por cada persona del festival que invites y participe (max. 5)",
...
const ca = withServerErrors({
  ...
  bonusDraw: {
    ...
    prompt:
      ...
      inviteTicket: "1 extra per cada persona del festival que convidis i participi (max. 5)",
...
const en = withServerErrors({
  ...
  bonusDraw: {
    ...
    prompt:
      ...
      inviteTicket: "1 extra for each person at the festival you invite who takes part (max. 5)",
...
const fr = withServerErrors({
  ...
  bonusDraw: {
    ...
    prompt:
      ...
      inviteTicket: "1 supplémentaire par personne du festival que vous invitez et qui participe (max. 5)",
...
const pt = withServerErrors({
  ...
  bonusDraw: {
    ...
    prompt:
      ...
      inviteTicket: "1 extra por cada pessoa do festival que convidares e que participe (max. 5)",
      achievedLabel: "Conseguida",
...
const it = withServerErrors({
  ...
  bonusDraw: {
    ...
    prompt: "Quale numero pensi che le persone ci diranno più spesso?",
      ...
      inviteTicket: "1 extra per ogni persona del festival che inviti e che partecipa (max. 5)",
